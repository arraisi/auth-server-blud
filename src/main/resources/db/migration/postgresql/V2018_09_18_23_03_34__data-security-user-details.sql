insert into auth.users (
    id, username, email, password, is_active, is_keep_active, is_locked, is_sudo, login_failed_counter,
    created_by, created_date, last_update_by, last_update_date)
values
       ('admin', 'admin', 'admin@example.com', '$2a$11$hDHpHn.Y4Vkg42/hfs4.EeaNqd7w7Ol431vtdyjG99bTErbFYiSpm', true, true, false, true, 0, 'migration', now(), null, null),
       ('user','user', 'user@example.com', '$2a$11$hAA3UdVhJOKhRs5ZQ/Erb.gXYArGpXMD54b6XrIecVSp.K59ROaIO', true, false, false , false , 0, 'migration', now(), null , null),
       ('default','default', 'default@example.com', '$2a$11$AXYPPPkahtX6BGmYRy9Kq.UZOesq10//ZsObUvUS3a.BUiB12UB7a', true , false , false , false, 0, 'migration', now(), null ,null);

insert into auth.roles(id, name, description)
values
       (0, 'ROLE_PUBLIC', 'Public role'),
...
values
       (uuid_generate_v4(), 'public', 'admin', 'migration', now()),
