...
VALUES ('001', 'Kas BLUD', 'app.kas', null, 0, 'migration', 'blud-resource-server', null);
insert into COMPONENT_MENUS(ID, TITLE, PATH, ICON_ID, IS_MENU, CREATED_BY, RESOURCE_ID, PARENT_ID)
VALUES ('002', 'Pendapatan', 'app.pendapatan', null, 0, 'migration', 'blud-resource-server', null);
insert into COMPONENT_MENUS(ID, TITLE, PATH, ICON_ID, IS_MENU, CREATED_BY, RESOURCE_ID, PARENT_ID)
VALUES ('003', 'Rencana Belanja', 'app.rincian', null, 0, 'migration', 'blud-resource-server', null);
insert into COMPONENT_MENUS(ID, TITLE, PATH, ICON_ID, IS_MENU, CREATED_BY, RESOURCE_ID, PARENT_ID)
