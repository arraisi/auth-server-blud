...
insert into RESOURCE_APPLICATION(ID, NAME, CREATED_BY, CREATED_DATE) values ('blud-resource-server', 'RBA-BLUD Resource Server', 'migration', current_timestamp);
...
insert into RESOURCE_CLIENT_APPLICATIONS(CLIENT_DETAIL_ID, APP_ID, CREATED_BY, CREATED_DATE)
values ('client-web', 'blud-resource-server', 'migration', current_timestamp);
insert into RESOURCE_CLIENT_APPLICATIONS(CLIENT_DETAIL_ID, APP_ID, CREATED_BY, CREATED_DATE)
values ('blud-resource-server', 'blud-resource-server', 'migration', current_timestamp);
